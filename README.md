...
Programa: Trilha de Certificação AI First — DGS / DB1 Global Software Escopo: Cenário-Âncora 3 — Fase de Governança e Validação (exercícios 3.1 e 3.2) Referência: Usar com avaliacao-foundation.md para dimensões e escala.
